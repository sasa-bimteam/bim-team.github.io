  ...
  <footer id="footer">
    ...
    <section>
      ...
      <ul className="icons">
        ...
        <li>
          <a href="https://www.youtube.com/channel/UC4tOYIWTNe1z-ODyH4Y5X0g" className="icon fa-facebook alt">
    ...
    <p className="copyright">
      copyright&copy; 2021 by BIM Team, all rights reserved worldwide.<br /> Narejeno z ❤️ v Sloveniji
    </p>
  </footer>
)
